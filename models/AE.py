...
class Autoencoder():
    ...
    def _build(self):
        ...
        for i in range(self.n_layers_encoder):
            ...
            for i in range(self.n_layers_decoder):
                ...
                model_input = self.encoder(encoder_input)
    ...
    def compile(self, learning_rate, verbose=1):
        ...
        self.model.compile(optimizer=optimizer, loss=r_loss, verbose=verbose)
    ...
    def train(self, x_train, batch_size, epochs, run_folder, print_every_n_batches=100, initial_epoch=0, lr_decay=1, verbose=2):
